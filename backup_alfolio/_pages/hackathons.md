...
### Features Developed
1. **Code to Flowchart Conversion** - Automated visual representation of code logic
2. **Code Complexity Analysis** - Evaluated algorithmic complexity metrics
3. **Maintainability Index Calculator** - Assessed code quality and maintainability
4. **Malicious Git Commit Tracker** - Security tool for detecting suspicious repository changes
